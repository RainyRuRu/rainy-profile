      ...
      <div class="container mx-auto">
        <div class="flex flex-row flex-wrap items-center gap-7 xl:gap-20 z-10 relative py-12 px-[30px] sm:px-0">
          ...
          <div class="flex flex-col justify-center items-start py-5 gap-5">
            ...
            <div class="text-dark text-[20px] font-semibold leading-7">Backend Engineer, August 2016 - Present</div>
            <div class="text-dark font-normal font-[16px] leading-8">
              <ol class="list-decimal pl-5">
                <li>內部 CMS 開發與維護</li>
                <li>API 設計開發與維護</li>
                <li>聆聽紀錄統整與排行榜計算</li>
                <li>建立服務監控機制 (Grafana & Rollbar)</li>
                <li>服務異常問題排解</li>
                <li>技術文件撰寫</li>
                <li>跨部門工作需求協調</li>
                <li>團隊工作流程改善與工作分配</li>
